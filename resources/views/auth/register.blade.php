                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('register') }}">
                                @csrf                                
                                <div class="row mb-3">
                                    <label for="fname" class="col-md-4 col-form-label text-md-end fw-bold">{{ __('First Name') }}</label>
                                ...
                                <div class="row mb-3">
                                    <label for="surname" class="col-md-4 col-form-label text-md-end fw-bold">{{ __('Last Name') }}</label>
